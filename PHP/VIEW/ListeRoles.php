...
<div class="espace"></div>
    ...
    foreach ($roles as $unRole) {
        if ($unRole->getIdRole() != 1) {
            ...
            <div class="modifier centre marginBouton"><a class="centre size" href="index.php?page=FormulaireRoles&choix=roles&mode=modifier&id=' . $unRole->getIdRole() . '">Modifier</a></div>
